...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col justify-between items-start rounded-r-lg">
      <div
      ...
      ></div>
      <div
        className={`rounded-r-3xl flex flex-col justify-between h-[100vh] fixed inset-y-0  left-0 z-40 w-64 bg-white overflow-y-auto transition duration-300 transform ${
      ...
      >
        ...
        <div>
          ...
          <div className="bg-[#EEEEE4] rounded-lg shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] w-10/12 mx-auto p-4 mb-10 flex flex-col justify-center items-center">
            ...
            <button className="bg-[#E9A53F] w-full px-3 py-3 text-white text-sm font-bold mx-auto rounded-full">
              Get Vichayan Plus
            </button>
          </div>
